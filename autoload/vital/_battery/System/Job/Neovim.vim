...
execute join(['function! vital#_battery#System#Job#Neovim#import() abort', printf("return map({'is_available': '', 'start': ''}, \"vital#_battery#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
